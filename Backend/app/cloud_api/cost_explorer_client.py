...
def get_monthly_cost(role_arn: Optional[str] = None) -> dict:
    ...
    try:
        ...
        raise ValueError("AWS credentials not found. Please configure valid AWS credentials.")
    except ClientError as e:
        raise ValueError(f"AWS API error: {e.response.get('Error', {}).get('Message', str(e))}")
